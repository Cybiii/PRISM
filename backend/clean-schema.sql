...
-- Clean version without line-wrapping issues
...
-- Insert default color clusters (fixed the line-break issue)
INSERT INTO public.color_clusters (
  cluster_number, 
  r_center, 
  g_center, 
  b_center, 
